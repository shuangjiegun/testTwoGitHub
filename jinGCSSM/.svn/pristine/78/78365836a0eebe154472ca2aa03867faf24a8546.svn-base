...
<form name="form1" id="form1" method="post" action="${rc.contextPath}/preAllotOrSubscribeSecond.do">	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
    	...
    	<!-- <p class="error">认购金额不足100元！</p> -->
        <ul class="bg-lightgray formInput mb30">
          <li> <em style="width:100px;">认购金额</em>
            <input type="text" name="money" id="ren" class="textInput"  placeholder="1000元起">
          </li>
...
<button type="button" class="btn btnSmall"   id="tom">继续认购</button>
</div>
