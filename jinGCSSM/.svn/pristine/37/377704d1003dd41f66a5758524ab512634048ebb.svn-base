...
<div class="dataListB mb20">	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
          ...
          <tr>
            <th>基金名称</th>
            <td>${cashBack.fund_code}  ${cashBack.fund_name}</td>
          </tr>
          <tr>
            <th>金额</th>
          ...
          <tr>
          <th>取现方式</th>
          <td><#if businessType=="normal">普通取现<#elseif businessType=="fast">快速取现<#else>出错</#if></td>
        </tr>
          <tr>
            <th>手续费</th>
            <td>免手续费</td>                                
    ...
    <p class="tips">温馨提示：取现申请成功，资金打款正在处理中，预计<#if businessType=="normal">T+1<#elseif businessType=="fast">T+0<#else>出错</#if>个交易日到账。</p>
    <button type="button" class="btn btnOne bg-white" id="btn">确认</button>
</div>	
