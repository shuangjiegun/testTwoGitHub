...
public class Test_pay_query_collect extends UfxSDKCommon{
    private Map<String, Object> request;

    private String url = "/pay_query_collect";

	@Before
	public void setUp() throws Exception {
		//SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
        String format = "20150601100536";
        String orderDate = format.substring(0, 8);
        String orderTime = format.substring(8);


        String orderId = "0020150601100536";
